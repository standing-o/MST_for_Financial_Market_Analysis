...
dp_1 = modif_cv[1,,]
t_dp_1 = table(dp_1)[2:31]
write_xlsx(as.data.frame(t_dp_1), path = "modif_central_vertex_dp1.xlsx")

all_dp_mst = modif_cv[,1,]
write_xlsx(as.data.frame(all_dp_mst), path = "central_vertex_all_dp.xlsx")
